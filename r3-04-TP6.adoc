...
disponible sur moodle et à importer dans un workspace
{Eclipse}.
...
Vous devez obtenir une architecture inclue dans celle-ci. Attention, votre structure de classe sera légèrement différente, avec un attribut code par exemple, des méthodes et des classes en moins :
...
.	Renommer cette classe en un nom contenant "ActionList" et bien choisi. 
