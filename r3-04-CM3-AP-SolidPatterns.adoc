...
== Un peu d'histoire sur la définition des patrons de conception
...
*	Définir une classe :
**	Etre capable de dire ce que fait la classe : "La classe X fait ..."
...
=== _**D**ependency Inversion Principle_ (Ségrégation des interfaces - Inversion des dépendances)
