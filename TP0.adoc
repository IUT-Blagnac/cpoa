...
. J'ai un identifiant {GitHub}.
. Je connais {git} et l'intégration continue (CI) sous {github}.
| {objtd}	| Mettre en place un environnement de travail pérenne pour tout le semestre.
