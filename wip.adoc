...
- Abstract Factory
- Retour sur SOLID
- Exemple complet (cours de B. Meyer)
- Quizz
...
image::event3.jpg[width=80%]

[{topic}]
== Nuit de l'info

image::event2.jpg[width=80%]

[{topic}]
== Merci aux étudiants volontaires

image::event4.png[width=60%]
...
[{incremental}]
- Attendus	{nbsp}92
- Rendus	{nbsp}55	(59%) => 37 `0/20`
- Nom NOK	{nbsp}23	(41% des rendus) => 23 `0/20` de plus
- Exemple de rendus erronés : `TP1_uml.png`, `TP1.uml.txt`, `SuperCanardBof.rar`, `CPOA_TP1_John_Smith_2B.uml`, `TP1.txt`, `TP1.zip`, `uml.uml`

ifdef::slides[== Retour TP1 (suite)]

image::TP1-retours.png[width=60%]
...
ifdef::slides[== Réunion de département]

[incremental]
- Process: TA -> Prof -> Chef -> Département
- "Notes TP1 1/10 du TP" => ???
- Rendu de TP dimanche soir : Non (en général)
- Retard : Non (en général)
- MPA : injustice du sujet de départ : Non

ifdef::slides[== Discord IUT]

[incremental]
- Attention, on n'est pas connecté 7/24 !
- J'ai corrigé tous les QCMs qui m'ont été envoyé...
- ...sauf ceux à 23h30 la veille!
...
include::refactoringBanque.txt[leveloffset=+1]

include::machine-a-etat.asc[leveloffset=+1]

include::etat.adoc[leveloffset=+1]

include::adapteur.asc[leveloffset=+1]
...
Vous déposerez avant le vendredi 20/01/2016 à minuit sur le dépôt moodle deux
...
TIP: Pensez à discord pour les questions!!

[{intro}]
== Stages

- 16 étudiants placés (23%)
- 12 stages à l'étranger (17%)
- 6 conventions signées
- Augmentation de l'indemnité (mais toujours 15% du plafond sécu)
