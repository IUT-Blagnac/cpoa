...
include::proxy.asc[leveloffset=+1]

include::iterateur.asc[leveloffset=+1]

include::composite.asc[leveloffset=+1]

include::patterns4.asc[leveloffset=+1]
