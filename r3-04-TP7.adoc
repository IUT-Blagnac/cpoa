...
| {duree}	| *2* TP de 1,5h.
| {depot} | *Les répertoires src des différentes versions de codes produits.*
|======================
...
.	Regarder les lignes 39-40 de `gui.vue.SimpleFrame`. A quoi servent-elles ?
...
... Redimensionner en cachant/affichant des lignes entières
... Redimensionner en cachant/affichant 1 seule colonne
