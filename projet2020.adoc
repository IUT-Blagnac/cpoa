...
// Thanks to Louis Chanoua for the code & idea
// ------------------------------------------
...
You have up to December 17th, 2020 to improve as much as possible the code of your chosen application:
...
- documentation quality (illustration, explanations)
