...
* Dans une première approche, ne prenez pas en compte l'aspect multithread et les problèmes potentiels induits. Si vous avez une solution éprouvée : mettez-la en oeuvre ET testez-la.
