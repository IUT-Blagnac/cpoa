...
image::liskov.jpg[scaledwidth="60%", link="https://www.dropbox.com/s/u4wenpfkbml8et0/Capture%20d%27%C3%A9cran%202017-11-08%2015.12.20.png?dl=0"]
...
[source,java,highlight=3..4|6..13|15..33]
----
class Rectangle
{
...
.Réponse (`Rectangle.java`)
[source,java,highlight=1..7|9..19]
----
class LspTest
{
