...
| {duree}	| *1* TD and *2* TPs (spread on 2 weeks)
|======================
...
//----------------------------- Question ------------------
.*CrossWords* (sorry, in French)
image::crossword1.png[link="images/crossword1.png"]

WARNING: This crossword is taken from the book mentioned
earlier, and hence includes definitions of words that you can't guess:
