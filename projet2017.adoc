...
[WARNING]
=====
Si vous n'avez pas Maven (ce qui est le cas des machines de l'IUT, désolé) :
...
. À partir du code de test et des sources, déterminez ce que fait l'application et comment elle fonctionne.
