...
Vous travaillerez sur un projet GitHub créé pour l'occasion sur le groupe de l'IUT de Blagnac (https://github.com/iut-blagnac/) via un lien classroom (qui vus sera donné par ailleurs) et qui devra s'appeler : `s4-01-2023-xyz` où `xyz` sera remplacé par le nom que vous voulez. 
