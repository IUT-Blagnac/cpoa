...
= {doctitle}
:Author:  {authorDefault} - (Semaine 39)
:lang: fr
:incremental:
...
4. Je maîtrise les diagrammes UML de classe, de séquence.
| {objtd}	| Aborder quelques subtilités *UML* et réviser le diagramme d'état.
| {duree}	| *1* TD
|======================
...
NOTE: Vous apprendrez à refactorer cette application en R3-04-Qualité, l'objectif n'est donc pas
